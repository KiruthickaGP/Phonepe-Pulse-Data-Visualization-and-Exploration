...
conn = mysql.connector.connect(user='root', password='Kimoni1710@?', host='127.0.0.1', database="phonepe")
...
if SELECT == "Home":
    col1,col2, = st.columns(2)
    col1.image(Image.open("C:/Users/Kiruthicka/Downloads/phonepe.png"),width = 500)
    with col1:
    ...
    with col2:
        st.video("C:/Users/Kiruthicka/Downloads/Phonepay_video.mp4")
    ...
    Data_Aggregated_Transaction_df= pd.read_csv(r'C:/Users/Kiruthicka/Downloads/Data_Aggregated_Transaction_Table.csv')
    Data_Aggregated_User_Summary_df= pd.read_csv(r'C:/Users/Kiruthicka/Downloads/Data_Aggregated_User_Summary_Table.csv')
    Data_Aggregated_User_df= pd.read_csv(r'C:/Users/Kiruthicka/Downloads/Data_Aggregated_User_Table.csv')
    Scatter_Geo_Dataset =  pd.read_csv(r'C:/Users/Kiruthicka/Downloads/Data_Map_Districts_Longitude_Latitude.csv')
    Coropleth_Dataset =  pd.read_csv(r'C:/Users/Kiruthicka/Downloads/Data_Map_IndiaStates_TU.csv')
    Data_Map_Transaction_df = pd.read_csv(r'C:/Users/Kiruthicka/Downloads/Data_Map_Transaction_Table.csv')
    Data_Map_User_Table= pd.read_csv(r'C:/Users/Kiruthicka/Downloads/Data_Map_User_Table.csv')
    Indian_States= pd.read_csv(r'C:/Users/Kiruthicka/Downloads/Longitude_Latitude_State_Table.csv')
...
#combining districts states and coropleth
    ...
    st.write("### **:white[PhonePe India Map]**")
...
# -----------------------------------------------FIGURE2 HIDDEN BARGRAPH------------------------------------------------------------------------
    ...
    with st.expander("See Bar graph for the same data"):
        ...
        st.info('**:white[The above bar graph showing the increasing order of PhonePe Transactions according to the states of India, Here we can observe the top states with highest Transaction by looking at graph]**')
...
if SELECT == "About":
    col1,col2 = st.columns(2)
    with col1:
        st.video("C:/Users/Kiruthicka/Downloads/pulse-video.mp4")
    with col2:
        st.image(Image.open("C:/Users/Kiruthicka/Downloads/download (1).jpg"),width = 300)
        st.write("---")
    ...
    with col1:
        ...
        st.image(Image.open(r"C:/Users/Kiruthicka/Downloads/about1.jpg"), width=400)
        with open("E:/Guvidatascience/Projects/Phonepay_project/PhonePe_Pulse_BCG_report.pdf","rb") as f:
            data = f.read()
        st.download_button("DOWNLOAD REPORT",data,file_name="annual report.pdf")
    with col2:
        st.image(Image.open(r"C:/Users/Kiruthicka/Downloads/about2.jpg"), width=400)
